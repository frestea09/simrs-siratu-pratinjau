...
const columns: ColumnDef<Risk>[] = [
    ...
    { accessorKey: "riskScore", header: "Skor Risiko (CxL)", cell: info => info.getValue(), size: 50 },
    ...
    { accessorKey: "controllability", header: "Controllability (CI)", cell: info => info.getValue(), size: 50 },
