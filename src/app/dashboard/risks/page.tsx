...
export default function RisksPage() {
  ...
  const summary = React.useMemo(() => {
    ...
    const statusCounts: Record<RiskStatus, number> = {
      Open: 0,
      "In Progress": 0,
      Closed: 0,
    }
    ...
    return {
      ...
      levelData: Object.entries(levelCounts)
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Risiko baru yang butuh evaluasi
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Risiko yang membutuhkan perhatian segera
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Kelola dan monitor semua risiko yang telah diidentifikasi di
                seluruh unit kerja.
              </CardDescription>
            </div>
      ...
      >
        ...
        <div className="print-page">
          <h3 className="mb-4 text-lg font-semibold">
            Daftar Rencana Aksi & Tindak Lanjut (Risiko Open & In Progress)
          </h3>
