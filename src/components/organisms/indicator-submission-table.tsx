...
export function IndicatorSubmissionTable({ indicators }: IndicatorSubmissionTableProps) {
  ...
  const table = useReactTable({
    ...
    onSortingChange: (sorting) => setTableState({ sorting }),
    onColumnFiltersChange: (filters) => setTableState({ columnFilters: filters }),
    onColumnVisibilityChange: (visibility) => setTableState({ columnVisibility: visibility }),
    onRowSelectionChange: (selection) => setTableState({ rowSelection: selection }),
