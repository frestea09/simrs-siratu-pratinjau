...
const profileSchema = z.object({
  title: z.string().min(10, "Judul harus memiliki setidaknya 10 karakter."),
  purpose: z.string().min(10, "Tujuan harus memiliki setidaknya 10 karakter."),
  ...
  exclusionCriteria: z.string().min(10, "Kriteria eksklusi harus diisi."),
  dataRecording: z.string().min(10, "Pencatatan data harus dijelaskan."),
  unitRecap: z.string().min(10, "Rekapitulasi unit harus dijelaskan."),
  analysisReporting: z.string().min(10, "Analisis dan pelaporan harus dijelaskan."),
  area: z.string().min(3, "Area harus diisi."),
  pic: z.string().min(2, "PIC harus diisi."),
