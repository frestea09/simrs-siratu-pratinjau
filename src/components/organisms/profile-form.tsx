            ...
            <form className="space-y-4 py-4 max-h-[70vh] overflow-y-auto pr-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                    <FormField control={form.control} name="area" render={({ field }) => (
                        <FormItem className="md:col-span-1"><FormLabel>Area Monitoring</FormLabel><FormControl><Input placeholder="Contoh: Seluruh area rawat inap" {...field} /></FormControl><FormMessage /></FormItem>
                    )} />
