...
const ageGroupOptions = [
  { value: "0-1 bulan", label: "0-1 bulan" },
  { value: ">1 bln - 1 thn", label: ">1 bln - 1 thn" },
  { value: ">1 thn - 5 thn", label: ">1 thn - 5 thn" },
  { value: ">5 thn - 15 thn", label: ">5 thn - 15 thn" },
  { value: ">15 thn - 30 thn", label: ">15 thn - 30 thn" },
  { value: ">30 thn - 65 thn", label: ">30 thn - 65 thn" },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-2">
        ...
        <FormInputRadio
          ...
          value={data.ageGroup ?? ""}
          onValueChange={(val) => onUpdate({ ageGroup: val })}
        />
        <FormInputSelect
          id="payer"
          ...
          items={payerOptions}
          value={data.payer ?? ""}
          onValueChange={(val) => onUpdate({ payer: val })}
        />
      </div>
      <Separator />
      ...
      <div className="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-2">
        <FormInputDate
          ...
          selected={data.entryDate ? new Date(data.entryDate) : undefined}
          onSelect={(date) => onUpdate({ entryDate: date?.toISOString() })}
        />
        <FormInputTime
          id="entry-time"
          label="Jam Masuk RS"
