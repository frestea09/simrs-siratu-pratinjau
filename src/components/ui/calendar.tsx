...
import { DayPicker, DropdownProps, CustomComponents } from "react-day-picker"
...
type DropdownWithChildrenProps = DropdownProps & {
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        Dropdown: (props: DropdownWithChildrenProps) => {
